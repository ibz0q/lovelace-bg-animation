...
// Response: [{"data":{"item":{"id":"RdpmGJ","itemType":"Pen","title":"Coalesce 22","owner":{"id":"DjdBLp","title":"Liam Egan","sessionUser":{"id":"982762","followsOwner":false,"__typename":"OwnerSessionUser"},"__typename":"User"},"__typename":"Pen"},"sessionUser":{"id":"VoDkNZ","currentContext":{"id":"VoDkNZ","title":"Captain Anonymous","__typename":"User"},"__typename":"User"}}},{"data":{"item":{"id":"RdpmGJ","cpid":"0169599e-7a00-7c57-916c-d1db25d1b86c","__typename":"Pen","token":null,"title":"Coalesce 22","private":false,"description":{"source":{"body":"GPGPU particles using texture caches for position and velocity.\n\nFor more of these experiments, please see:\nhttps://codepen.io/collection/XEEaEa/","__typename":"Content"},"__typename":"ProcessableContent"},"url":"https://codepen.io/shubniggurath/pen/RdpmGJ","sessionUser":{"id":"33634050","ownsItem":false,"__typename":"ItemSessionUser"}}}}]
...
Modify the script so it makes the below fetch call and populates the yaml metadata for example author: Liam Egan (using the location of this in the json below)  and description  "GPGPU particles using texture caches for position and velocity.\n\nFor more of these experiments, please see:\nhttps://codepen.io/collection/XEEaEa/"
